...
exports.logger = content => {
  ...
  const file = PATH.resolve(dir, `${Date.now()}-${Math.random().toString(36).slice(3)}.txt`);
...
exports.checkForUpdates = () => {
  if (
    !process.env.YTSR_NO_UPDATE &&
    !pkg.version.startsWith('0.0.0-') &&
    Date.now() - exports.lastUpdateCheck >= UPDATE_INTERVAL
  ) {
    exports.lastUpdateCheck = Date.now();
    return request('https://api.github.com/repos/distubejs/ytsr/contents/package.json', {
